...
echo <<<HTML
			<tr> 
				...
				<td>
					<big><a class="{$ocultar}" href="#" onclick="editar('{$id}', '{$descricao}', '{$fornecedor}','{$valor}','{$data_venc}','{$arquivo}', '{$funcionario}', '{$obs}','{$hospede}')" title="Editar Dados"><i class="fa fa-edit text-primary "></i></a></big>
